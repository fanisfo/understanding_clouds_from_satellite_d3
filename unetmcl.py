...
class UNetMultiClass(nn.Module):
    def __init__(self, in_channels=3, out_channels=4):  # out_channels = number of classes + background
    ...
    def forward(self, x):
        ...
        dec3 = self.dec3(F.max_pool2d(dec4, kernel_size=2))
        ...
        # Final output
        output = self.final_conv(F.max_pool2d(dec1, kernel_size=2))
        return output
